...
public class TestSwing extends JFrame {
	...
	public TestSwing() {
		...
		setDefaultCloseOperation(EXIT_ON_CLOSE); // 닫기 버튼 눌러서 resource 정리하고 창 닫기
...
//		contentPane.add(new JButton("CENTER"), BorderLayout.CENTER);
		...
		JTextField txtSubjet = new JTextField();
...
class MyActionListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source instanceof JButton) {
			System.out.println(" y u click button nigga");
			...
			System.out.println("y u press enter in textfield nigga");
		}
