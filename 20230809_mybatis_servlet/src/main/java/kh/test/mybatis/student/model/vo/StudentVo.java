...
public class StudentVo {
	...
	public String toString() {
		return "StudentVo [studentNo=" + studentNo + ", departmentNo=" + departmentNo + ", studentName=" + studentName
				+ ", studentSsn=" + studentSsn + ", studentAddess=" + studentAddess + ", entranceDate=" + entranceDate
				+ ", absenceYn=" + absenceYn + ", coachProfessorNo=" + coachProfessorNo + ", departmentName="
				+ departmentName + "]";
	}
	public StudentVo(String studentNo, String departmentNo, String studentName, String studentSsn, String studentAddess,
			String entranceDate, String absenceYn, String coachProfessorNo, String departmentName) {
		super();
